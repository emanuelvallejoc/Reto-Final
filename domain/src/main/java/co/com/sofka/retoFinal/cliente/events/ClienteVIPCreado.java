...
public class ClienteVIPCreado extends DomainEvent {
    ...
    public ClienteVIPCreado(ClienteId entityId, CuentaId cuentaId, Email email, Password password, ClienteVIPId clienteVIPId, TipoDocumento tipoDocumento, NumeroDocumento documento, Nombre nombre) {
        super("producto.ClienteVIPCreado");
